...
def get_correlation_basic(attn_med_flag ):
    ...
    all_29_29_feature_list =  {'TEX_SHORT':[], 'TEX_LONG':[], 'PIC_PIC':[], 'VID_SHORT':[],'VID_LONG':[]}  
    all_29_29_label_list =  {'TEX_SHORT':[], 'TEX_LONG':[], 'PIC_PIC':[], 'VID_SHORT':[],'VID_LONG':[]}  
    ...
    for user_id, data in all_users_slide_popularity.items(): 
        ...
        print count
        count += 1
        label_list = {'TEX_SHORT':[], 'TEX_LONG':[], 'PIC_PIC':[], 'VID_SHORT':[],'VID_LONG':[]}  
        feature_list = {'TEX_SHORT':[], 'TEX_LONG':[], 'PIC_PIC':[], 'VID_SHORT':[],'VID_LONG':[]}  
        for slide_no,popularity in sorted(data.items()):
            feature_val = ''
            #stimulus_tag = META_DATA[slide_no][2][:3]
            stimulus_tag =  META_DATA[stimulus_id][2][:3].upper() + "_" + META_DATA[stimulus_id][3].strip().upper()
...
def get_correlation_blink(attn_med_flag ):
...
if __name__ == "__main__":
    ...
    get_correlation_blink("attn")
    get_correlation_blink("med")
